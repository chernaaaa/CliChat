...
* **Язык:** `Java 17+`. Мы выбрали Java, потому что в ней удобно работать с многопоточностью (нам нужно одновременно слушать сеть и читать ввод с клавиатуры), плюс мы с ней хорошо знакомы.
